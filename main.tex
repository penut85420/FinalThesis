...
% 強勢語言弱勢語言論
% 論文定調為使用資源豐富的領域與強勢語言（英文與簡體中文等）的優勢來助長弱勢語言的發展。
