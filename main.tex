...
% \usepackage[backend=plain]{biblatex}
% \usepackage{biblatex}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    Premise & 約瑟夫·傅立葉是十九世紀法國數學家及物理學家。\\
    & (Joseph Fourier was a French mathematician and physicist in the 19th century.) \\ \hline
    Hypothesis & 十九世紀法國的約瑟夫·傅立葉是數學家、物理學家。\\
    & (Joseph Fourier born in French in the 19th century was a mathematician and physicist.) \\ \hline
    % ??MERGE INT
    % Joseph Fourier was a French mathematician and physicist in the 19th century.
    % Joseph Fourier born in French in the 19th century was a mathematician and physicist.
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    \hline
    Premise & 約瑟夫·傅立葉是十九世紀法國數學家、物理學家。 \\
    & (Joseph Fourier was a French mathematician and physicist in the 19th century.) \\ \hline
    Hypothesis & 約瑟夫·傅立葉是物理學家。 \\
...
% 把 Mixed 跟 Pretraining-Finetuning 的做法分開來講
% 在這邊提到 ECN Conv BFCI 的方法
\paragraph{}
...
\begin{table}[H]
  ...
  WAG Only & 0.4062 & \textbf{0.5415} & 0.3137 & 0.4015 \\ \hline
  WAG + ML Features & \textbf{0.4283} & 0.5407 & \textbf{0.3364} & \textbf{0.4069} \\ \hline
  \end{tabular}
