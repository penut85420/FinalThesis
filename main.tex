...
\paragraph{}
% NLI 任務在定義上相當單純，給定一句 Premise 和一句 Hypothesis，
The definition of NLI task is quite simple, given a premise sentence and a hypothesis sentence, and recognizing if the two sentences are entailment.
...
\paragraph{}
The best and verified system of OCNLI from the official leaderboard\footnote{https://www.cluebenchmarks.com/nli.html} is RoBERTa which achieves an accuracy of 77.3\% using RoBERTa.
