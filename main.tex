...
\begin{table}[H]
  ...
  % ?? 舉 Lv1~3 相同的例子
  % ?? 舉 Lv1~4 相同的例子
  % ?? 說明每個 Level 的類別是什麼，跟 table 10 做搭配
  % \texttt{Ba01A03@} & 萬物 \\
  \texttt{Cb06E09@} & 民間 \\
...
\paragraph{}
We use the WUP similarity \cite{wu-palmer-1994-verb} in WordNet, as defined in Eq(\ref{eq:3}), to construct semantic features.
% ?? 解釋 s1 s2 synsets
