...
\begin{equation} \label{eq:wup_word}
  wup_{word}(w_1,w_2)=\max\limits_{\substack{s_1\in synsets(w_1) \\ s_2\in synsets(w_2)}} wup(s_1,s_2)
\end{equation}
...
\begin{equation} \label{eq:lv5}
  lv5(W_1,W_2)=\frac{1}{|C_1|}\sum\limits_{w_1\in W_1}\max\limits_{w_2\in W_2} sim(w_1,w_2)
\end{equation}
