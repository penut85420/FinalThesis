...
\paragraph{}
Table \ref{result:bert-detailed} shows the detailed performance of different systems of BERT. When using RITE2 as test set, F1-score of ``contradiction'' is lowest. When using RITE-VAL as test set, F1-score of ``independence'' is lowest. We think this is caused by the label distribution of the training set.

% ?? 結論看著這個表格說話
\begin{table}[H]
  \centering
  \setlength{\extrarowheight}{-3pt}
  \caption{The Detailed Performance of Different Systems}
