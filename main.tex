...
% TODO: 補上 CIRB 的資訊
\paragraph{}
We use the CIRB (Chinese Information Retrieval Benchmark)\cite{chen2001cirb} dataset as our corpus. CIRB is a news collection downloaded from websites of Chinatimes\footnote{https://www.chinatimes.com/}, Chinatimes Commercial\footnote{https://ctee.com.tw/}, Chinatimes Express, Central Daily News, and China Daily News from 1998 to 2005 which use as the test collection in the Chinese text retrieval tasks of NTCIR 2. We generate the dataset equally according to the four labels, each generation method also generates an equal number of data under each label. Both rule-based and GPT2 will generate 400k sentence pairs that similar to the data size scale of the MNLI dataset, 800k sentence pairs are generated totally.
