...
\begin{table}[H]
  \centering
  \setlength{\extrarowheight}{-3pt}
  \caption{Results of BERT Using Extended RITE}
  \label{bert_rite_ex}
  \begin{tabular}{|c|l|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
  \hline
  \multirow{2}{*}{System} & \multicolumn{1}{c|}{\multirow{2}{*}{Training}} & \multicolumn{2}{c|}{RITE2} & \multicolumn{2}{c|}{RITE-VAL} \\ \cline{3-6}
   & \multicolumn{1}{c|}{} & Dev & Test & Dev & Test \\ \hline
...
\begin{table}[H]
  ...
  GRU + CSA & \textbf{0.5472} & \textbf{0.3981} & 0.4133 & \textbf{0.3327} \\ \hline
  GRU + MLFT & 0.4821 & 0.3704 & 0.3238 & 0.2389 \\ \hline
  GRU + CSA + MLFT & 0.5408 & 0.3903 & 0.4090 & 0.3306 \\ \hline
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  GRU + CSA + MLFT & 0.4847 & 0.4643 & 0.4601 & 0.3762 \\ \hline
  BERT & 0.5377 & 0.5950 & 0.4766 & \textbf{0.4993} \\ \hline
  BERT + CSA + MLFT & \textbf{0.5407} & \textbf{0.6027} & \textbf{0.4853} & 0.4857 \\ \hline
  \end{tabular}
\end{table}
